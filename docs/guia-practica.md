# Guía práctica — PlataformaDomotica

Guía paso a paso completa (7 fases) usada para construir este laboratorio de
LLM local + domótica. Para una vista general rápida, consulta el [README](../README.md).
